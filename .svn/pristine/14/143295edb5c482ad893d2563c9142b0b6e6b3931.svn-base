...
+(UIImage *)scaleImage:(UIImage *)image toWidth:(NSInteger)toWidth toHeight:(NSInteger)toHeight{
	NSInteger width=0;
	NSInteger height=0;
	NSInteger x=0;
	NSInteger y=0;
...
+(NSData *)scaleData:(NSData *)imageData toWidth:(NSInteger)toWidth toHeight:(NSInteger)toHeight{
