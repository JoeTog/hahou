...
#define kZBShareMenuItemIconSize 86
...
- (void)setup{
    self.backgroundColor = [UIColor colorWithRed:254.0/255 green:254.0/255 blue:254.0/255 alpha:1];
    ...
    if (!_shareMenuPageControl) {
        ...
        [shareMenuPageControl setPageIndicatorTintColor:[UIColor lightGrayColor]];
        [shareMenuPageControl setCurrentPageIndicatorTintColor:[UIColor grayColor]];
        ...
        shareMenuPageControl.numberOfPages = 2;
...
- (void)reloadData {
    ...
    CGFloat paddingX = 16;
    CGFloat paddingY = 10;
    CGFloat sep = ( SCREEN_WIDTH - kZBShareMenuItemIconSize*kZBMessageShareMenuPerRowItemCount - paddingX)/3.0;
