...
+ (CGFloat)durtaionAtIndex:(size_t)index source:(CGImageSourceRef)source{
    ...
    NSDictionary *gifProperties = dicProperties[(__bridge NSString *)kCGImagePropertyGIFDictionary];
    NSNumber *delayTimeUnclamped = gifProperties[(__bridge NSString *)kCGImagePropertyGIFUnclampedDelayTime];
