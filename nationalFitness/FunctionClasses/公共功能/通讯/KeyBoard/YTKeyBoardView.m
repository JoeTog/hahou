...
- (void)addIcons{
    ...
    self.icons = @[audio,emoji,more];// audio
...
//    text.frame = CGRectMake(CGRectGetMaxX(self.audio.frame)+ICON_LR, ICON_TOP, KB_WIDTH-ICON_WH*2.0f-ICON_LR*4.0f, hight);
    text.frame = CGRectMake(CGRectGetMaxX(self.audio.frame)+ICON_LR, ICON_TOP, KB_WIDTH-ICON_WH*3.0f-ICON_LR*6.0f, hight);
...
#pragma mark - 点击键盘功能按钮 录音、表情、更多等
...
#pragma mark - 表情代理chat Emoji View Delegate
