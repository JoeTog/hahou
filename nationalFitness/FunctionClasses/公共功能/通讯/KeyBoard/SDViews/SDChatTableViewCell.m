...
-(void)setupUI{
    ...
    titleLabel.frame = CGRectMake(70, 10, SCREEN_WIDTH-90-70, 25);
    ...
    detailLabel.frame = CGRectMake(70, 35, SCREEN_WIDTH-100, 25);
    ...
    timeLabel.frame = CGRectMake(SCREEN_WIDTH-90, 10,80, 25);
    ...
    numLabel.frame = CGRectMake(SCREEN_WIDTH-35,40,20,15);
