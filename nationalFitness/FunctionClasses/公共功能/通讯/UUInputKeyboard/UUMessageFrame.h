...
//#define ChatPicWH kPLUS_SCALE_X(130)      //图片宽高
#define ChatPicWH kPLUS_SCALE_X(100)      //图片宽高
#define ChatContentW 229    //内容宽度

#define ChatTimeMarginW 15  //时间文本与边框间隔宽度方向
#define ChatTimeMarginH 10  //时间文本与边框间隔高度方向

#define ChatContentTop 8   //文本内容与按钮上边缘间隔
...
@property (nonatomic, assign) BOOL showTimeHead;
