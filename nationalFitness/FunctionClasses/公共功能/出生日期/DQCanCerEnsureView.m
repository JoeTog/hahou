...
- (void)creadtionAllSubView{
    ...
    [CanCerBtn setTitleColor:UIColorFromRGB(0x666666) forState:UIControlStateNormal];
    ...
    [EnsureBtn setTitleColor:UIColorFromRGB(0x333333) forState:UIControlStateNormal];
