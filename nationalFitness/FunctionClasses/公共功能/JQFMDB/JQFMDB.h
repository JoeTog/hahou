...
//懒加载
@property (strong, nonatomic) ClearManager *myManage;    //懒加载 fmdbServicee

////懒加载
//@property (strong, nonatomic) NSString *stringWithCStringName;    //懒加载
//
////type
//@property (strong, nonatomic) NSString *stringWithCStringType;    //懒加载
...
#pragma mark - 模糊搜索 某表中条数据后面数据的条数
...
#pragma mark - 表中条件为xxx的数据个数是多少 【找某个表中某条件的数据个数】
