...
//@end
//
@implementation RPFSearchFriendVC
//
//
...
//
//
//    float maxY = CGRectGetMaxY(self.navigationController.navigationBar.frame);
//    NSLog(@"navigationBar.y = %.2f",maxY);
//    float searchBarHeight = 40.0;
//    UISearchBar * searchBar = [[UISearchBar alloc] init];
//
//    searchBar.frame = CGRectMake(0, maxY,[UIScreen mainScreen].bounds.size.width, searchBarHeight);
//    searchBar.delegate = self;
//    searchBar.backgroundColor = [UIColor colorWithRed:237.0/255 green:240.0/255 blue:245.0/255 alpha:1.0];
//    searchBar.placeholder = @"输入好友ID或昵称";
//
//    //self.view.backgroundColor = [UIColor colorWithRed:237.0/255 green:240.0/255 blue:245.0/255 alpha:1.0];
//
//    [self.view addSubview:searchBar];
//
//
//    self.view.backgroundColor = [UIColor whiteColor];
//    self.tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(searchBar.frame), self.view.bounds.size.width, self.view.bounds.size.height-CGRectGetMaxY(searchBar.frame)) style:UITableViewStylePlain];
...
//- (void)prepareData{
//
//    _contacts = [[NTESGroupedContacts alloc] initWithSearchWord:nil];
//
...
//
//    //[_contacts setMembers:[self updateWithSearchWord:@"wo120"]];
//
//}
//
//- (NSMutableArray *)updateWithSearchWord:(NSString *)searchWord
//{
...
//        for (NIMUser *user in [NIMSDK sharedSDK].userManager.myFriends)
//        {
//            if([user.userId isEqualToString:searchWord] || [user.alias isEqualToString:searchWord] || [user.userInfo.nickName isEqualToString:searchWord])
//            {
//                NIMKitInfo *info           = [[NIMKit sharedKit] infoByUser:user.userId option:nil];
//                NTESContactDataMember *contact = [[NTESContactDataMember alloc] init];
//                contact.info               = info;
...
//
//
//- (void)prepareDataWithSearchWord:(NSString *)searchWord{
//
//    _contacts = [[NTESGroupedContacts alloc] initWithSearchWord:searchWord];
//
//    NSString *contactCellUtilIcon   = @"icon";
//    NSString *contactCellUtilVC     = @"vc";
//    NSString *contactCellUtilBadge  = @"badge";
...
//
//    //    if(self.dataStatic==nil)
//    //    {
//    //        self.dataStatic = [NSArray arrayWithArray:self.data];
//    //    }
//
//    if(searchText && ![searchText isEqualToString:@""])
//    {
//        [_contacts updateWithSearchWord:searchText];
//
//    }
//    else
//    {
//        [_contacts updateWithSearchWord:nil];
//
//    }
//
...
//    UIActionSheet *sheet = [[UIActionSheet alloc] initWithTitle:@"选择操作" delegate:nil cancelButtonTitle:@"取消" destructiveButtonTitle:nil otherButtonTitles:@"添加好友",@"创建群聊",@"搜索群聊", nil];
//
//
...
//                    option.clientCustomInfo = [RPFTool convertToJsonData:@{@"GroupName":qunName}];
//
