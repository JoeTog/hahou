...
- (void)drawRect:(CGRect)rect {
    ...
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.textNumLabel attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1 constant:100]];
