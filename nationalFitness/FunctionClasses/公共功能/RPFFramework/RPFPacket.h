...
UIKIT_EXTERN NSString * const kRPFPacketShow;/**< 界面出现 */
UIKIT_EXTERN NSString * const kRPFPacketHide;/**< 界面消失 */
 ...
 */
+ (void)instanceRPFPacketWithPartnerId:(NSString *)partnerId EnvelopeName:(NSString *)envName aliPaySchemeUrl:(NSString *)aliPayscheme weChatSchemeUrl:(NSString *)weChatScheme appMothod:(BOOL)isOnLine;
...
/**
 ...
 @param isOnLine             是否正式环境 YES：正式环境    NO：测试环境
 */
+ (void)instanceRPFPacketWithPartnerId:(NSString *)partnerId EnvelopeName:(NSString *)envName aliPaySchemeUrl:(NSString *)aliPayscheme weChatSchemeUrl:(NSString *)weChatScheme customerClass:(NSString *)className dynamicToken:(BOOL)dynamicToken appMothod:(BOOL)isOnLine;
...
/**
 ...
 @discussion     方法已废除废除；通过instanceRPFPacket方法进行设置
 */
