...
-(void)setAmountLabelHidden:(BOOL)hidden
{
    _amountLabel.hidden = hidden;
}
...
- (void)drawView {
    if (!_paymentAlert) {
        ...
        [_closeBtn addTarget:self action:@selector(CloseDismiss) forControlEvents:UIControlEventTouchUpInside];
