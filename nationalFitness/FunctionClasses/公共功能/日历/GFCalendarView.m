...
//浅浅灰
#define kCalendarBasicColor [UIColor colorWithRed:249.0 / 255.0 green:250.0 / 255.0 blue:251.0 / 255.0 alpha:1.0]
...
- (instancetype)initWithFrameOrigin:(CGPoint)origin width:(CGFloat)width {
    ...
    // 星期头部栏高度
    CGFloat weekHeaderHeight = 0.5 * weekLineHight;
    
    // calendar 头部栏高度
    CGFloat calendarHeaderHeight = 0.7 * weekLineHight;
