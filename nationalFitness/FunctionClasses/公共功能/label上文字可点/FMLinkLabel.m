...
//            NSLog(@"\n idx:%d \n",idx);
            if (rectValue) {
                touchPoint =  [rectValue CGRectValue];
//                NSLog(@"\n%f\n",touchPoint.origin.x);
//                if (touchPoint.origin.y < 0) {
//                    touchPoint.origin.y = 0;
//                }
//                touchPoint.origin.x = touchPoint.origin.x * 2;
//                touchPoint.size.width += 15;
//                touchPoint.size.height += 2;
//                touchPoint.origin.y -= 1;
//                touchPoint.origin.x -= 1;
                
            }
            //注释下面一行 接收所有点击事件
//            if (CGRectContainsPoint(touchPoint, point)) {
                if (obj.clickBlock) {
