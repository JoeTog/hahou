...
// AlertW 宽
#define AlertW SCREEN_WIDTH/3*2
// AlertW gao
#define AlertH SCREEN_WIDTH/3*2
// AlertW gao
#define titleOrginY 40
// 各个栏目之间的距离
#define MKPSpace 10.0
#define UIColorFromRGB(rgbValue) [UIColor colorWithRed:((float)((rgbValue & 0xFF0000) >> 16))/255.0 green:((float)((rgbValue & 0xFF00) >> 8))/255.0 blue:((float)(rgbValue & 0xFF))/255.0 alpha:1.0]

#define TextColor UIColorFromRGB(0x435a8e)
...
//            self.titleLbl = [self GetAdaptiveLable:CGRectMake(2*MKPSpace, 2*MKPSpace, AlertW-4*MKPSpace, 20) AndText:title andIsTitle:YES];
            self.titleLbl = [self GetAdaptiveLable:CGRectMake(2*MKPSpace, titleOrginY, AlertW-4*MKPSpace, 20) AndText:title andIsTitle:YES];
        ...
        if (message) {
            ...
            self.msgLbl.textColor = TextColor;
        ...
        if (cancleTitle && sureTitle)
        {
            ...
            [self.cancleBtn setBackgroundImage:[self imageWithColor:UIColorFromRGB(0xdedede)] forState:UIControlStateSelected];
        ...
        if(sureTitle && cancleTitle){
            ...
            // 改颜色
            [self.sureBtn setTitleColor:TextColor forState:UIControlStateNormal];
            [self.sureBtn setBackgroundImage:[self imageWithColor:UIColorFromRGB(0xdedede)] forState:UIControlStateSelected];
...
//        UILabel *lineLab = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, AlertW, 7)];
//        lineLab.backgroundColor = UIColorFromRGB(0x623b3e);
//        lineLab.layer.cornerRadius = 4.0;
//        lineLab.layer.masksToBounds = YES;
//        [self.alertView addSubview:lineLab];
        
        UIImageView *titleImage = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, AlertW, 7)];
        titleImage.image = [UIImage imageNamed:@"alert"];
