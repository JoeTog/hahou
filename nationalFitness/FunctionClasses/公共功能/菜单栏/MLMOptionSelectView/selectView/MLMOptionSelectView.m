...
- (void)showAndDraw {
    ...
    switch (_diretionType) {
        ...
        case MLMOptionSelectViewBottom:
        {
            ...
            if (self.optionType == MLMOptionSelectViewTypeCustom) {
                NSLog(@" %f& %f& %f& %f",_edgeInsets.top,_edgeInsets.left,_edgeInsets.bottom,_edgeInsets.right);
                ...
                self.origin = CGPointMake(0, top>bottom?_edgeInsets.top:_edgeInsets.bottom);
            }else{
