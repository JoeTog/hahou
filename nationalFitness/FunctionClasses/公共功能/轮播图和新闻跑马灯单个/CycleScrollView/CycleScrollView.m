...
- (void)initialization
{
    ...
    _pageControlStyle = CycleScrollViewPageContolStyleClassic;
...
- (void)setCurrentPageDotImage:(UIImage *)currentPageDotImage
{
    ...
    if (self.pageControlStyle != CycleScrollViewPageContolStyleAnimated) {
        self.pageControlStyle = CycleScrollViewPageContolStyleAnimated;
    }
